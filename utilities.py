...
def primary_gpu_supports_vulkan(major: int, minor: int, patch: int = 0) -> bool:
    from ctypes import cast, pointer, c_int, c_void_p, POINTER, c_char_p, c_uint32

    from vulkan import (vkCreateInstance, VkInstanceCreateInfo, VkStructureType, VkApplicationInfo,
    ...
    vk_instance = cast(pointer(c_int(0)), c_void_p)
    ...
    devices_handle_result = vkEnumeratePhysicalDevices(vk_instance, num_devices, devices)
